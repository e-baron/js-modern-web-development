  ...
  myMSALObj.loginPopup(loginRequest)
    .then(loginResponse => {
      ...
      if (myMSALObj.getAccount()) {
        //console.log("sign in:", myMSALObj.getAccount());
...
const getUserName = () => myMSALObj.getAccount() ? myMSALObj.getAccount().userName : undefined;
const getName = () => myMSALObj.getAccount() ? myMSALObj.getAccount().name : undefined ;
const getIdToken = () => myMSALObj.getAccount() ? sessionStorage.getItem("msal.idtoken") : undefined ;
...
export {signIn, signOut, myMSALObj, getUserName, getName, getIdToken, acquireTokenSilent};